...
summary_cards:
- title: Selective lineage
  body: A scoped map of the civilizational horizon most immediately available to the
    authors, not a complete global history of thought.
- title: Central lineage
  body: Leibniz, Kant, Einstein, Gödel, Wheeler, and Grothendieck as key representatives
    of a coherence-seeking orientation.
...
right_rail:
  ...
  - title: Why the Tau Framework
    url: /research-program/about/why-the-tau-framework/
