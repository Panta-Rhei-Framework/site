---
layout: program-doc
title: Why This Research Program Exists
nav_order: 2
lane: research-program
section: about-the-research
summary_short: Why the program emerges from dissatisfaction with fragmented accounts
  of reality and from the search for a world-picture that can be both scientifically
  intelligible and existentially inhabitable.
summary_cards:
- title: First fragmentation
  body: Modern knowledge is powerful locally yet often fragmented across incompatible
    foundational languages and explanatory styles.
- title: Second fragmentation
...
right_rail:
  ...
  - title: Science, Humanities & Coherence
    url: /research-program/about/science-humanities-and-coherence/
  - title: Historical Context
    url: /research-program/about/historical-context/
  meta:
    type: Essay
    scope: Program-wide
    status: Canonical
