...
summary_short: An overview of what the Panta Rhei Research Program is, what it releases
  publicly, and what kind of research object it asks the world to engage.
summary_cards:
- title: What this is
  body: An independent open research program, not merely a book series or a software
    project.
- title: Current canonical release
  body: Seven books, the Atlas website, TauLib, guided tours, verification companions,
