...
<div class="dep-list">
  <a class="dep-link" href="{{ '/publications/monograph-supplements/numerical-physics-ledger/' | relative_url }}"><span class="dep-title">Numerical Physics Ledger</span><span class="dep-meta">Numerical ledger / physics supplement originally planned as part of the Book V architecture.</span></a>
  <a class="dep-link" href="{{ '/publications/monograph-supplements/categorical-genesis/' | relative_url }}"><span class="dep-title">Categorical Genesis</span><span class="dep-meta">Book VII supplement / genesis appendix developed from later monograph material.</span></a>
</div>
