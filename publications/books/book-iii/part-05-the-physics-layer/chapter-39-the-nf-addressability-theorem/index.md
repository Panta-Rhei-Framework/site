...
permalink: /publications/books/book-iii/part-05-the-physics-layer/chapter-39-the-nf-addressability-theorem/
lane: publications
...
page_in_book: 195
prev_chapter_url: "/publications/books/book-iii/part-05-the-physics-layer/chapter-38-sigma/"
...
is NF-addressable in every primitive sector
$S ∈ \{A, B, C, D\}$.
...
The theorem closes the Hodge block
and delivers the structural input
for Part X's orthodox bridge.
