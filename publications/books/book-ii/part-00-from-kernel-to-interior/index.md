...
permalink: /publications/books/book-ii/part-00-from-kernel-to-interior/
lane: publications
...
not a power ($τ^3 ≠ τ × τ × τ$),
and not an independent construction ($τ^3$ *is* $τ$, read geometrically).
The base $τ^1$ and fiber $T^2$ are coordinate projections,
not standalone entities.
This distinction—between the ontic unity of $τ$
and the geometric readout $τ^3$—runs through
