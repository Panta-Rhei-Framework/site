...
title: "Chapter 72: Diagonal Discipline as Linear Logic"
permalink: /publications/books/book-i/part-17-the-proof-theoretic-mirror/chapter-72-diagonal-discipline-as-linear-logic/
lane: publications
...
page_in_book: 327
prev_chapter_url: "/publications/books/book-i/part-17-the-proof-theoretic-mirror/chapter-71-the-meta-logical-toolkit/"
prev_chapter_title: "Chapter 71: The Meta-Logical Toolkit"
next_chapter_url: "/publications/books/book-i/part-17-the-proof-theoretic-mirror/chapter-73-the-taulib-linearity-audit/"
next_chapter_title: "Chapter 73: The TauLib Linearity Audit"
summary_short: "Chapter [ch:meta-logical-toolkit] inventoried the meta-logical substrate — CIC's structural rules that Book I imported but did not earn. One finding stood out:…"
...
Chapter [ch:meta-logical-toolkit] inventoried the meta-logical
...
(Theorem [thm:diagonal-linear], I.T37) establishes that
$K5$'s three constraints map isomorphically onto the
$!$-free fragment of Girard's linear logic (1987).
The program monoid of Chapter [ch:program-monoid]
(Definition [def:program-monoid], I.D14)
reinterprets as a linear sequent calculus,
with NF-Confluence (Lemma [lem:nf-confluence], I.L02)
as cut-elimination.
Truth4 (Definition [def:truth4], I.D21)
...
is evidence that both frameworks respond to
