...
status: "canonical"
summary_short: "Physics stress-test entry: Magnetoreception."
...
source:
  ...
  source_item_anchor: "magnetoreception"
  source_line: 224
  source_section:
    - "Biophysics"
  ...
  source_entry_records:
    -
      source_entry_id: "wikipedia-physics-magnetoreception"
      source_name: "wikipedia_list_of_unsolved_problems_in_physics"
      ...
      source_revision_id: "1349830343"
      source_revision_timestamp: "2026-04-19T03:02:56Z"
      source_title: "Magnetoreception"
      source_section:
        - "Biophysics"
      source_line: 224
      source_text: "Magnetoreception: How do animals (e.g. migratory birds) sense the Earth's magnetic field?"
      problem_statement: "How do animals (e.g. migratory birds) sense the Earth's magnetic field?"
      source_questions: []
      source_links:
        -
          label: "Magnetoreception"
          url: "https://en.wikipedia.org/wiki/Magnetoreception"
          target: "Magnetoreception"
  source_links:
    -
      label: "Magnetoreception"
      url: "https://en.wikipedia.org/wiki/Magnetoreception"
...
- `wikipedia-physics-magnetoreception` — Wikipedia: List of unsolved problems in physics; section: Biophysics; source line: 224; revision: 1349830343.
