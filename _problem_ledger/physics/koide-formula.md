...
status: "canonical"
summary_short: "Physics stress-test entry: Koide formula."
...
source:
  ...
  source_item_anchor: "koide-formula"
  source_line: 146
  source_section:
  ...
  source_entry_records:
    -
      source_entry_id: "wikipedia-physics-koide-formula"
      source_name: "wikipedia_list_of_unsolved_problems_in_physics"
      ...
      source_revision_id: "1349830343"
      source_revision_timestamp: "2026-04-19T03:02:56Z"
      source_title: "Koide formula"
      source_section:
        - "High-energy/particle physics"
      source_line: 146
      source_text: "Koide formula: An aspect of the problem of particle generations. The sum of the masses of the three charged leptons, divided by the square of the sum of the roots of these masses, to within one standard deviation of observations, is . It is unknown how such a simple value comes about, and why it is the exact arithmetic average of the possible extreme values of (equal masses) and 1 (one mass dominates)"
      problem_statement: "An aspect of the problem of particle generations. The sum of the masses of the three charged leptons, divided by the square of the sum of the roots of these masses, to within one standard deviation of observations, is . It is unknown how such a simple value comes about, and why it is the exact arithmetic average of the possible extreme values of (equal masses) and 1 (one mass dominates)"
      source_questions: []
      source_links:
        -
          label: "Koide formula"
          url: "https://en.wikipedia.org/wiki/Koide_formula"
          target: "Koide formula"
        -
          label: "problem of particle generations"
...
- [problem of particle generations](https://en.wikipedia.org/wiki/Generation_(particle_physics))
- [lepton](https://en.wikipedia.org/wiki/lepton)

## Source Trace

- `wikipedia-physics-koide-formula` — Wikipedia: List of unsolved problems in physics; section: High-energy/particle physics; source line: 146; revision: 1349830343.
