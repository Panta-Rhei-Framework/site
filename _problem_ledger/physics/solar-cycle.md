...
status: "canonical"
summary_short: "Physics stress-test entry: Solar cycle."
...
source:
  ...
  source_item_anchor: "solar-cycle"
  source_line: 154
  source_section:
  ...
  source_entry_ids:
    - "wikipedia-physics-solar-cycle"
  source_entry_records:
    -
      source_entry_id: "wikipedia-physics-solar-cycle"
      source_name: "wikipedia_list_of_unsolved_problems_in_physics"
      ...
      source_revision_id: "1349830343"
      source_revision_timestamp: "2026-04-19T03:02:56Z"
      source_title: "Solar cycle"
      source_section:
        - "Astronomy and astrophysics"
      source_line: 154
      source_text: "Solar cycle: How does the Sun generate its periodically reversing large-scale magnetic field? How do other solar-like stars generate their magnetic fields, and what are the similarities and differences between stellar activity cycles and that of the Sun? What caused the Maunder Minimum and other grand minima, and how does the solar cycle recover from a minima state?"
      problem_statement: "How does the Sun generate its periodically reversing large-scale magnetic field? How do other solar-like stars generate their magnetic fields, and what are the similarities and differences between stellar activity cycles and that of the Sun? What caused the Maunder Minimum and other grand minima, and how does the solar cycle recover from a minima state?"
      source_questions: []
      source_links:
        -
          label: "Solar cycle"
...
mapping:
  ...
  mapping_target: "phys-solar-cycle"
...
- [Maunder Minimum](https://en.wikipedia.org/wiki/Maunder_Minimum)

## Source Trace

- `wikipedia-physics-solar-cycle` — Wikipedia: List of unsolved problems in physics; section: Astronomy and astrophysics; source line: 154; revision: 1349830343.
