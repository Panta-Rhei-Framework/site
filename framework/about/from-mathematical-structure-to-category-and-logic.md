...
summary_short: The framework earns arrows, composition, internal logic, and topos-like
  resources rather than taking them as primitives.
summary_cards:
- title: Main move
  body: The framework earns arrows, composition, internal logic, and topos-like resources
    rather than taking them as primitives.
- title: Strategic importance
  body: This is where Tau becomes mathematically rich enough to host its own further
...
*This is step 4 of 16 in the [conceptual staircase]({{ '/framework/about/' | relative_url }}). It builds on [From Symbolic Discipline to Mathematical Structure]({{ '/framework/about/from-symbolic-discipline-to-mathematical-structure/' | relative_url }}).*
...
By the end of this stage, the framework is no longer simply a symbolic kernel with interesting arithmetic consequences. The detailed development of this ascent runs through [Book II]({{ '/publications/books/book-ii/' | relative_url }}). It has become a mathematical environment with enough internal organization to host:
- logic,
- relation,
...
*The next step, [Boundary, Interior, and Readout]({{ '/framework/about/boundary-interior-and-readout/' | relative_url }}), explores how continuity and geometrical expression are earned from boundary structure.*
