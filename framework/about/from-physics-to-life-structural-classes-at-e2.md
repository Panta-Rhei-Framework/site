---
layout: program-doc
title: 'From Physics to Life: Structural Classes at E2'
nav_order: 12
lane: framework
section: about-the-framework
summary_short: At E2, the semantic target rises from physical invariants to the structural
  classes and trajectories through which life tends to organize itself.
summary_cards:
- title: Main move
  body: At E2, the semantic target rises from physical invariants to the structural
    classes and trajectories through which life tends to organize itself.
- title: Key clarification
  body: The life claim is not token-level biology but higher-order structural mapping
    on top of an E1 physical substrate.
right_rail:
  related:
  - title: Life
    url: /framework/life/
  ...
  - title: 'From Life to Metaphysics: Reflective Structure at E3'
    url: /framework/about/from-life-to-metaphysics-reflective-structure-at-e3/
  - title: How the Four Layers Determine Reality Differently
    url: /framework/about/how-the-four-layers-determine-reality-differently/
  meta:
    type: Lane Intro
...
This does not mean that life overrides physics. On the contrary, the program explicitly treats life as realized on the physical substrate of \(E_1\). The chemistry, energetics, and material processes of living systems remain physical all the way down. Nothing in the life layer suspends or replaces the physical one.

What \(E_2\) adds is a higher-order structural organization.
