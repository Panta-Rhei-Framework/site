---
layout: program-doc
title: Why the Framework Begins So Low
nav_order: 3
lane: framework
section: about-the-framework
summary_short: The stronger the downstream explanatory ambition, the stricter the
  upstream foundation must be.
summary_cards:
- title: Foundational wager
  body: The stronger the downstream explanatory ambition, the stricter the upstream
    foundation must be.
- title: Public takeaway
  body: Tau begins below ordinary category theory because the program refuses to import
    the very structures it later wants to explain.
right_rail:
  related:
...
*This is step 2 of 16 in the [conceptual staircase]({{ '/framework/about/' | relative_url }}). It builds on [What the Tau Framework Is]({{ '/framework/about/what-the-tau-framework-is/' | relative_url }}).*
...
*The next step, [From Symbolic Discipline to Mathematical Structure]({{ '/framework/about/from-symbolic-discipline-to-mathematical-structure/' | relative_url }}), explores how the first ascent from bare symbols to stable mathematical objects actually works.*
