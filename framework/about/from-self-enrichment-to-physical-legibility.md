...
summary_short: Physics begins when the enriched framework becomes semantically legible
  as a candidate physical reality-model.
summary_cards:
- title: Main move
  body: Physics begins when the enriched framework becomes semantically legible as
    a candidate physical reality-model.
- title: Why this is difficult
  body: This is not routine mathematical modeling. It is the claim that a fully specified
    internal layer admits a complete physical reading.
right_rail:
  related:
  - title: Physics
  ...
  - title: Structural Isomorphism and Calibrated Readout
    url: /framework/about/structural-isomorphism-and-calibrated-readout/
  - title: 'From Physics to Life: Structural Classes at E2'
    url: /framework/about/from-physics-to-life-structural-classes-at-e2/
  meta:
    type: Lane Intro
...
5. and the later books argue that a two-input Calibration Cascade (ι_τ + m_n, propagated through four layers L0→L4) yields the corresponding physical readout, with a Calibration Sufficiency Theorem showing these two inputs fix every SI-valued prediction.
