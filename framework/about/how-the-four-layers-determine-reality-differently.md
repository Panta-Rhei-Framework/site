---
layout: program-doc
title: How the Four Layers Determine Reality Differently
nav_order: 14
lane: framework
section: about-the-framework
summary_short: 'Each layer determines reality in a different epistemic mode: ontic
  specification, invariant physical structure, structural life classes, and reflective
  architecture.'
summary_cards:
- title: Main move
  body: 'Each layer determines reality in a different epistemic mode: ontic specification,
    invariant physical structure, structural life classes, and reflective architecture.'
- title: Why it matters
  body: This page prevents the mistaken assumption that all four layers make the same
    kind of claim.
right_rail:
  related:
...
*This is step 13 of 16 in the [conceptual staircase]({{ '/framework/about/' | relative_url }}). It builds on [From Life to Metaphysics: Reflective Structure at E3]({{ '/framework/about/from-life-to-metaphysics-reflective-structure-at-e3/' | relative_url }}).*
...
At **\(E_0\)**, the framework speaks in its strongest [ontic]({{ '/framework/about/ontic-seriousness-and-the-question-of-existence/' | relative_url }}) mode. This is the level of the [kernel]({{ '/framework/about/what-the-tau-framework-is/' | relative_url }}) itself: the generators, the progression structure, the closure conditions, the earned mathematical world. Here the program takes the strongest stance available to it. The framework is not yet talking about one token among many. It is specifying the formal substrate itself.
...
*The next step, [What the Framework Does Not Assume]({{ '/framework/about/what-the-framework-does-not-assume/' | relative_url }}), explores the constraints the program refuses at the foundation.*
