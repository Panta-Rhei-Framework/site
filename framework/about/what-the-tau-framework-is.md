...
summary_short: The Tau framework is a candidate coherence-first formal substrate built
  from a radically constrained symbolic kernel rather than from already-assumed high-level
  mathematical objects.
summary_cards:
- title: Core answer
  body: The Tau framework is a candidate coherence-first formal substrate built from
    a radically constrained symbolic kernel rather than from already-assumed high-level
    mathematical objects.
- title: Why it matters
  body: It aims to test whether a full stack of reality can be built from a more disciplined
    foundation than ordinary modern frameworks typically require.
right_rail:
  related:
  ...
  - title: Why the Framework Begins So Low
    url: /framework/about/why-the-framework-begins-so-low/
