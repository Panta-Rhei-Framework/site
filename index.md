...
<div class="content-card homepage-section">
  ...
  <ul>
    ...
    <li><strong>Physics Ledger (free PDF)</strong>&mdash;the complete 209-page numerical scorecard with full derivations, available for download</li>
  </ul>
...
<div class="content-card homepage-section">
  ...
  <ul>
    ...
    <li><a href="{{ '/publications/physics-ledger/' | relative_url }}"><strong>Physics Ledger (free PDF)</strong></a>&mdash;67 predictions + 30 falsifications in one 209-page document</li>
