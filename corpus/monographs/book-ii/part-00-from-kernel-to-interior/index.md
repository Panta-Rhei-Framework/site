...
- **[Chapter 1: The Boundary-First Paradigm]({{ '/corpus/monographs/book-ii/part-00-from-kernel-to-interior/chapter-01-the-boundary-first-paradigm/' | relative_url }})**
- **[Chapter 2: The Elliptic-to-Split-Complex Shift]({{ '/corpus/monographs/book-ii/part-00-from-kernel-to-interior/chapter-02-the-elliptic-to-split-complex-shift/' | relative_url }})**
- **[Chapter 3: Roadmap and Inverted Dependency]({{ '/corpus/monographs/book-ii/part-00-from-kernel-to-interior/chapter-03-roadmap-and-inverted-dependency/' | relative_url }})**
