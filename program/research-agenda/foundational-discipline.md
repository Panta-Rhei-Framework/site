...
summary_cards:
- title: Thesis
  body: The stricter the foundational discipline, the more meaningful a later claim
    to unification becomes.
- title: Orientation
  body: Constructive, finitistically disciplined, typed, and resistant to unrestricted
    diagonal reuse.
- title: Why it matters
  body: A permissive kernel may yield expressive power, but it weakens later claims
...
- arbitrary foundational abundance
and
...
If the program later claims to have earned something large, that claim means more if it was earned under real foundational restraint. The [core design principles]({{ '/program/research-agenda/core-design-principles/' | relative_url }}) show how this discipline shapes the program's method at every level.
