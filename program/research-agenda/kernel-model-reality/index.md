...
<div class="v2-grid">
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/ontic-status-burden/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/kant-phenomena-noumena/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/diagrammatic-access/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/no-externalities/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/substrate-non-deferral/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/program/research-agenda/kernel-model-reality/answer-shape-requirements/' | relative_url }}">
