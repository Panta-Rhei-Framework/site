...
status: "Canonical"
summary_short: "The program is Kant-aware: it treats the phenomena/noumena boundary as serious while asking whether diagrammatic access can carry lawful structural warrant."
summary_cards:
  - title: "Phenomena"
    body: "The domain of appearance, measurement, practice, and experience where empirical accountability lives."
  - title: "Noumena"
    body: "The limiting thought of reality beyond direct appearance, not an object the program claims to inspect by pointing."
  - title: "Boundary"
    body: "The boundary is not dismissed; it is treated as a typed relation that any strong claim must respect."
hero_ctas:
