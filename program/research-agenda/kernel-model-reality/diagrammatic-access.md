...
status: "Canonical"
summary_short: "Diagrammatic access names the program's proposed route from formal structure to disciplined ontic seriousness, without claiming direct pointing access."
summary_cards:
  - title: "Not pictorial"
    body: "A diagram is a formal relational structure, not an illustration standing in for evidence."
  - title: "Not direct"
    body: "The access claimed here is not direct noumenal pointing; it is mediated, typed, and inspectable."
  - title: "Not optional"
    body: "Without an access mode, strong claims about kernel and reality would outrun their warrant."
hero_ctas:
  - label: "Kant Boundary"
...
<div class="v2-grid">
  <div class="v2-tile">
    ...
    <span>Formal relations must be explicit enough to support proof, formalization, and dependency tracking.</span>
  </div>
  <div class="v2-tile">
    <strong>Physics</strong>
    <span>Quantities, units, laws, regimes, and measurement bridges must be typed rather than smuggled in.</span>
  </div>
  <div class="v2-tile">
    <strong>Life</strong>
    <span>Boundary, metabolism, heredity, development, agency, and mind must not be flattened into a single borrowed grammar.</span>
  </div>
  <div class="v2-tile">
    <strong>Metaphysics</strong>
    <span>Being, relation, identity, causality, modality, truth, and value must be handled as explicit burdens.</span>
  </div>
</div>
