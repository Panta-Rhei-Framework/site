...
summary_cards:
  - title: "Stabilize"
    body: "Keep the public release reproducible, navigable, and correction-ready."
  - title: "Formalize"
...
<div class="v2-grid">
  ...
  <div class="v2-tile">
    ...
    <span>Make changes traceable through release notes, manifests, checksums, and explicit status labels.</span>
  </div>
</div>
