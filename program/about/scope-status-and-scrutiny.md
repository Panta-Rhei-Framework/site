---
layout: program-doc
title: Scope, Status, and Scrutiny
nav_order: 10
lane: program
v2_lane: program
...
summary_cards:
- title: Large scope
  body: The program addresses mathematics, physics, life, and metaphysics as one architecture.
- title: Current status
  body: Public, inspectable, canonically articulated, partially formalized, not socially
    settled.
- title: Invitation
  body: The right first question is not whether one already agrees, but whether the
    program has earned structured engagement.
right_rail:
  related:
