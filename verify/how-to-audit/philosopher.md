...
right_rail:
  related:
    ...
    - title: "Foundational Philosophy briefing"
      url: /results/fields/philosophy-foundational/
    - title: "Applied Philosophy briefing"
      url: /results/fields/philosophy-applied/
    - title: "Biology briefing"
      url: /results/fields/biology/
  meta:
    type: "Inspection Route"
    scope: "Philosophical claim audit"
    status: "Canonical"
    updated: "April 2026"
---
...
**Where to look:**
- [τ-Life vs Autopoiesis / IIT / FEP]({{ '/agenda/kernel-model-reality/related-approaches/deep-comparison/' | relative_url }}) — prior-art contrast
...
**Where to look:**
- [Consciousness as Global Section]({{ '/results/problem/consciousness-global-section/' | relative_url }})
...
- [τ-Life vs Autopoiesis / IIT / FEP]({{ '/agenda/kernel-model-reality/related-approaches/deep-comparison/' | relative_url }})
...
**Where to look:**
- [Categorical Imperative as Fixed Point]({{ '/results/problem/categorical-imperative-fixed-point/' | relative_url }})
- [Categorical Imperative Derivation]({{ '/results/problem/categorical-imperative-derivation/' | relative_url }})
- [Is-Ought Gap Bridged]({{ '/results/problem/is-ought-gap-bridged/' | relative_url }})
- [Moral Realism Derived]({{ '/results/problem/moral-realism-derived/' | relative_url }})
- [Applied Philosophy briefing]({{ '/results/fields/philosophy-applied/' | relative_url }})
...
- [Prior-Art Comparisons]({{ '/agenda/kernel-model-reality/related-approaches/deep-comparison/' | relative_url }}) — all five specialist-level contrasts
