...
### 1. The [Physics Ledger PDF]({{ '/assets/downloads/physics-ledger.pdf' | relative_url }}) (~150 pages, free download)
...
- **Check the CMB peak structure beyond the first peak.** The site documents the first peak at +69 ppm; does the framework predict the full peak structure (peaks 2, 3, 4...) with zero free parameters, or only peak 1? This is a concrete fact-check.
