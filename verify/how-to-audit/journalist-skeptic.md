...
- **If you're writing about the program,** the [Media Kit]({{ '/media/' | relative_url }}) has structured assets, [How to Verify]({{ '/verify/how-to-verify/' | relative_url }}) explains first-pass inspection routes, and [Assessment Protocols]({{ '/verify/assessment-protocols/' | relative_url }}) provides reviewer-ready workflows.
