...
*Previous: [Being and Becoming]({{ '/results/world-readout/physics/being-and-becoming-in-the-tau-universe/' | relative_url }}) | Next: [Why Laws Are Read Out, Not Imposed]({{ '/results/world-readout/physics/why-laws-are-read-out-not-imposed/' | relative_url }})*
