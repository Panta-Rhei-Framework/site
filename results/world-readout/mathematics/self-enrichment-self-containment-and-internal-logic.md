...
right_rail:
  ...
  meta:
    ...
    scope: Enrichment, self-hosting, internal logic
    status: Canonical
    updated: April 2026
---
...
If self-enrichment required ontic inflation, then the move from mathematics to [physics]({{ '/results/topic/physics/' | relative_url }}), [life]({{ '/results/topic/biology/' | relative_url }}), and [metaphysics]({{ '/results/topic/philosophy/' | relative_url }}) would look like a sequence of imported extras. But if self-enrichment reorganizes one already closed ontic world into higher structural articulation, then the later layers can be read as genuine unfoldings rather than added domains.
