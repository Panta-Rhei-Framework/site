...
right_rail:
  ...
  meta:
    ...
    scope: Mathematics world-picture
    status: Canonical
    updated: April 2026
---
...
Read in order, these pages form the conceptual entrance into the [76 mathematics results]({{ '/results/topic/mathematics/' | relative_url }}) of the program.
