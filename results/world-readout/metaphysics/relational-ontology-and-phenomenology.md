...
*Previous: [Final Self-Enrichment: Why No E4]({{ '/results/world-readout/metaphysics/the-final-self-enrichment-why-there-is-no-e4/' | relative_url }}) | Next: [Pattern, Language, and Proof]({{ '/results/world-readout/metaphysics/pattern-language-and-proof/' | relative_url }})*
