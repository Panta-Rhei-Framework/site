...
*Previous: [Pattern, Language, and Proof]({{ '/results/world-readout/metaphysics/pattern-language-and-proof/' | relative_url }}) | Next: [Mind, Consciousness, and the Self-Model]({{ '/results/world-readout/metaphysics/mind-consciousness-and-the-self-model/' | relative_url }})*
