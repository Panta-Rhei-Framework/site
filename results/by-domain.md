...
- [Abiogenesis Timescale](/results/problem/abiogenesis-timescale/) — Resolved
- [Abiogenesis Timescale Bound from Geometric Decay](/results/problem/abiogenesis-timescale-bound/) — Resolved
- [Aging Mechanism](/results/problem/aging-mechanism/) — Not Addressed
- [ATP Currency Uniqueness: Topology and Coupling Fix the Energy Scale](/results/problem/atp-currency-uniqueness/) — Resolved
- [ATP Uniqueness](/results/problem/atp-uniqueness/) — Resolved
- [BH-as-Alive](/results/problem/bh-as-alive/) — Resolved
...
- [Homochirality Universality: 12-Step Derivation from K0–K6 to L-Amino Acids](/results/problem/homochirality-universality-12-step-derivation/) — Resolved
- [Immune Specificity](/results/problem/immune-specificity/) — Not Addressed
- [Layer Separation: SelfDesc Is Unavailable at E₁](/results/problem/layer-separation/) — Resolved
...
- [Central Theorem: O(τ³) ≅ A_spec(L)](/results/problem/central-theorem/) — Resolved
- [Chirality / Symmetry Breaking Across E0–E2](/results/problem/chirality-symmetry-breaking-across-e0-e2/) — Resolved
- [Consciousness Across E1–E3](/results/problem/consciousness-across-e1-e3/) — Partial
- [Differentiation Is Irreversible: Waddington Descent Monotone](/results/problem/differentiation-irreversible/) — Resolved
- [Earned Topos](/results/problem/earned-topos/) — Resolved
- [Enrichment Ladder](/results/problem/enrichment-ladder/) — Resolved
...
- [Identity Theorem](/results/problem/identity-theorem/) — Resolved
- [Information / Self-Reference Across E0–E3](/results/problem/information-self-reference-across-e0-e3/) — Resolved
- [Koide Relation at −9 ppm: Q = 2/3 from σ-Equivariant Mass Matrix](/results/problem/koide-relation/) — Resolved
- [Kolmogorov Constant C_K = 3/2 Exact from dim(τ³)/dim(T²)](/results/problem/kolmogorov-constant-c-k-exact/) — Resolved
- [Langlands Program Approach](/results/problem/langlands-program-approach/) — Partial
- [Master Schema: All Eight Millennium Problems Are Instances of Mutual Determination](/results/problem/master-schema-millennium/) — Resolved
- [Modal Logic S4 as Theorem: τ-Modal Operators and Kripke Soundness](/results/problem/modal-logic-s4-theorem/) — Resolved
- [Muon Anomalous Magnetic Moment a_μ at +8.8 ppm](/results/problem/muon-anomalous-magnetic-moment-8pt8-ppm/) — Resolved
- [Mutual Determination: Five Characterizations of Holomorphic Functions](/results/problem/mutual-determination/) — Resolved
- [Neutrino Mass Sum Σm_ν = 0.089 eV, Normal Ordering Derived](/results/problem/neutrino-mass-sum-0pt089-ev-normal-ordering/) — Resolved
- [No Black Hole Evaporation: dM/dn ≥ 0 and Information Preserved](/results/problem/no-bh-evaporation/) — Contradicted
- [No Singularity: Profinite Structure Blocks a → 0](/results/problem/no-singularity-theorem/) — Resolved
- [Number Tower N → Z → Q → R → C](/results/problem/number-tower-n-z-q-r-c/) — Resolved
- [P vs NP](/results/problem/p-vs-np/) — Partial
- [Poincaré Conjecture Reinterpretation](/results/problem/poincar-conjecture-reinterpretation/) — Resolved
- [Prime Polarity](/results/problem/prime-polarity/) — Resolved
- [Prime Polarity: Primes as Finite Witnesses of Infinity](/results/problem/prime-polarity-theorem/) — Resolved
- [Proton Charge Radius r_p at +12 ppm (37× Improvement in Wave 46)](/results/problem/proton-charge-radius-12-ppm/) — Resolved
...
- [Rydberg Constant at Seven Significant Figures from τ](/results/problem/rydberg-constant-seven-significant-figures/) — Resolved
- [Saturation Theorem: The Enrichment Ladder Terminates at E₃](/results/problem/saturation-theorem-no-e4/) — Resolved
- [She–Lévêque Turbulence Exponents Exact from τ³ Dimensions](/results/problem/she-leveque-turbulence-exponents/) — Resolved
- [Stone Duality](/results/problem/stone-duality/) — Resolved
- [Strong CP Problem Solved: θ_QCD = 0 from SA-i Admissibility](/results/problem/strong-cp-problem-solved/) — Resolved
- [Structural Instability / ZFC Identity Slippage](/results/problem/structural-instability-zfc-identity-slippage/) — Contradicted
- [S₈ Tension Resolved: S₈ = 0.783 from f_supp × f_growth × f_ν](/results/problem/s8-tension-resolved-0pt783/) — Resolved
- [Tarski Axioms for Geometry](/results/problem/tarski-axioms-for-geometry/) — Resolved
- [Tau-Identity Theorem: Agreement at One Depth Implies Agreement Everywhere](/results/problem/tau-identity-theorem/) — Resolved
- [The τ-Coherence Kernel: Seven Axioms on Five Generators](/results/problem/tau-kernel-coherence/) — Resolved
- [Three Generations of Matter from H₁(τ³;ℤ) ≅ ℤ³](/results/problem/three-generations-matter/) — Resolved
- [Time Derivation Theorem: Proper Time from K0–K6](/results/problem/time-derivation-theorem/) — Resolved
- [Tower Machine Architecture](/results/problem/tower-machine-architecture/) — Resolved
...
- [Unique Infinity](/results/problem/unique-infinity/) — Resolved
- [W-Boson Mass Prediction at −0.5 ppm](/results/problem/w-boson-mass-prediction/) — Resolved
- [Weinberg Angle NNLO at −0.7 ppm](/results/problem/weinberg-angle-nnlo/) — Resolved
- [Why So Many Results Are Even Possible](/results/problem/why-so-many-results-are-even-possible/) — Resolved
- [Yang-Mills Mass Gap: δ∞^s > 0 Spectrally Isolated](/results/problem/yang-mills-mass-gap/) — Partial
- [Yoneda Lemma](/results/problem/yoneda-lemma/) — Resolved
...
- [Animal Rights and Dignity](/results/problem/animal-rights-and-dignity/) — Resolved
- [Beauty and Truth](/results/problem/beauty-and-truth/) — Resolved
- [Binding Problem Dissolved](/results/problem/binding-problem-dissolved/) — Resolved
...
- [Embodied Cognition](/results/problem/embodied-cognition/) — Resolved
- [Emotions as Register Transitions](/results/problem/emotions-as-register-transitions/) — Resolved
- [Extended Mind](/results/problem/extended-mind/) — Resolved
...
- [Gavagai and Indeterminacy of Translation](/results/problem/gavagai-and-indeterminacy-of-translation/) — Resolved
...
- [Intentionality](/results/problem/intentionality/) — Resolved
- [Intersubjectivity](/results/problem/intersubjectivity/) — Resolved
- [Is-Ought Gap Bridged](/results/problem/is-ought-gap-bridged/) — Resolved
...
- [Mereological Composition](/results/problem/mereological-composition/) — Resolved
- [Moral Realism Derived](/results/problem/moral-realism-derived/) — Resolved
- [Musical Universals](/results/problem/musical-universals/) — Resolved
- [Narrative Identity](/results/problem/narrative-identity/) — Resolved
- [No Forced Stance](/results/problem/no-forced-stance/) — Resolved
- [Ontological Dependence](/results/problem/ontological-dependence/) — Resolved
- [Paraconsistent Logic](/results/problem/paraconsistent-logic/) — Resolved
- [Persistence Through Change](/results/problem/persistence-through-change/) — Resolved
...
- [Syntax-Semantics Dissolution](/results/problem/syntax-semantics-dissolution/) — Resolved
...
- [The Sublime](/results/problem/the-sublime/) — Resolved
- [Trolley Problem Resolution](/results/problem/trolley-problem-resolution/) — Resolved
- [Why Something Rather Than Nothing](/results/problem/why-something-rather-than-nothing/) — Resolved
### [Physics](/results/topic/physics/) — 60 results

- [0νββ / Majorana Neutrinos](/results/problem/0-majorana-neutrinos/) — Resolved
- [Baryon Asymmetry](/results/problem/baryon-asymmetry/) — Resolved
- [BH Information Paradox](/results/problem/bh-information-paradox/) — Resolved
- [BH Quasi-Normal Modes](/results/problem/bh-quasi-normal-modes/) — Resolved
- [Chandrasekhar Mass Limit](/results/problem/chandrasekhar-mass-limit/) — Resolved
...
- [Deuterium Abundance](/results/problem/deuterium-abundance/) — Resolved
- [Electron Mass at 0.025 ppm: 10-Link Derivation from K0–K6](/results/problem/electron-mass-0025-ppm/) — Resolved
- [Electron Mass Precision](/results/problem/electron-mass-precision/) — Resolved
- [Emergence of Spacetime](/results/problem/emergence-of-spacetime/) — Partial
- [Equivalence Principle from τ](/results/problem/equivalence-principle-from/) — Resolved
- [Fine-Tuning Dissolved](/results/problem/fine-tuning-dissolved/) — Resolved
- [Flat Galaxy Rotation Curves from Capacity Gradient](/results/problem/flat-rotation-curves/) — Resolved
- [Galaxy Rotation Curves without Dark Matter](/results/problem/galaxy-rotation-curves-without-dark-matter/) — Resolved
- [Hierarchy Problem](/results/problem/hierarchy-problem/) — Resolved
- [Higgs Boson Mass Prediction at +8.0 ppm](/results/problem/higgs-mass-prediction/) — Resolved
- [Higgs Self-Coupling](/results/problem/higgs-self-coupling/) — Resolved
- [Higgs Self-Coupling λ_H = 0.12928 at +16 ppm](/results/problem/higgs-self-coupling-lambda-h-16-ppm/) — Resolved
- [High-Tc Superconductivity](/results/problem/high-tc-superconductivity/) — Partial
- [Hubble Tension](/results/problem/hubble-tension/) — Resolved
- [Individual Quark Masses](/results/problem/individual-quark-masses/) — Resolved
- [Inevitability: Six Ontic Requirements Force the τ-Kernel](/results/problem/tau-inevitability/) — Resolved
- [Inflation Mechanism](/results/problem/inflation-mechanism/) — Resolved
- [Li-7 Problem Resolved: ⁷Li/H via Fiber Suppression S = 1/3](/results/problem/lithium-7-problem-resolved/) — Resolved
- [Measurement Problem](/results/problem/measurement-problem/) — Resolved
- [Muon g−2 Anomaly](/results/problem/muon-g-2-anomaly/) — Resolved
- [Navier–Stokes Regularity](/results/problem/navier-stokes-regularity/) — Not Addressed
- [Neutrino Mass Ordering](/results/problem/neutrino-mass-ordering/) — Resolved
- [Neutron EDM](/results/problem/neutron-edm/) — Resolved
- [Neutron Lifetime Puzzle](/results/problem/neutron-lifetime-puzzle/) — Resolved
- [No Axion Needed](/results/problem/no-axion-needed/) — Contradicted
- [No Dark Matter Particle: Sector Exhaustion Theorem](/results/problem/no-dark-matter-particle/) — Resolved
- [No Hawking Radiation](/results/problem/no-hawking-radiation/) — Contradicted
- [Not MOND](/results/problem/not-mond/) — Contradicted
- [Periodic Table Structure](/results/problem/periodic-table-structure/) — Resolved
- [Physical Reality as a Semantic Reading of E1](/results/problem/physical-reality-as-a-semantic-reading-of-e1/) — Resolved
- [Primordial Gravitational Waves](/results/problem/primordial-gravitational-waves/) — Resolved
...
- [Proton-Neutron Mass Difference at +33 ppm](/results/problem/proton-neutron-mass-difference/) — Resolved
- [QCD Confinement](/results/problem/qcd-confinement/) — Partial
- [Quantum Computing](/results/problem/quantum-computing/) — Not Addressed
- [S8 Tension](/results/problem/s8-tension/) — Resolved
...
- [Vacuum Energy = 0: Cosmological Constant Problem Dissolved](/results/problem/vacuum-energy-zero/) — Resolved
- [W Mass Puzzle](/results/problem/w-mass-puzzle/) — Resolved
- [Weinberg Angle sin²θ_W Precision](/results/problem/weinberg-angle-sin-w-precision/) — Resolved
- [Why Three Generations?](/results/problem/why-three-generations/) — Resolved
