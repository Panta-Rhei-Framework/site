...
The cross-domain significance is that the same compactness argument that gives Ω_k = 0 also internally addresses the horizon problem (V.P91: dissolved by τ³ compactness) and yields the No-BH-Evaporation result.
