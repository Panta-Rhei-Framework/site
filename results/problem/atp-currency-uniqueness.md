...
VI.T19 proves that ATP (adenosine triphosphate) is the unique energy oscillation mode satisfying the Agency sector constraints: topology (the membrane = lemniscate boundary L = S¹ ∨ S¹) plus the π-coupling of the Agency sector admit exactly one admissible energy oscillation. The result establishes ATP not as a historical evolutionary choice but as the structurally forced energy currency of any E₂ life system using the Agency sector.
