---
layout: "program-doc"
title: "Ball lightning - Problem Answer"
permalink: "/results/problem-ledger-answers/physics/ball-lightning/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Atmospheric electricity mystery is too specific and observational for current Corpus scope."
canonical_problem_id: "phys-ball-lightning"
problem_answer_id: "answer-phys-ball-lightning"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Atmospheric electricity mystery is too specific and observational for current Corpus scope.

Rationale: Atmospheric electricity mystery is too specific and observational for current Corpus scope.
...
- Reviewed in the outside-current-books double-check; Atmospheric electricity mystery outside current Corpus.
...
- Final empty-map scope classification: Declared out of scope — Atmospheric electricity mystery is too specific and observational for current Corpus scope.
