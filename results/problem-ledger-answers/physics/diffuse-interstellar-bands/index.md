---
layout: "program-doc"
title: "Diffuse interstellar bands - Problem Answer"
permalink: "/results/problem-ledger-answers/physics/diffuse-interstellar-bands/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Specific astrochemical identification problem is outside current scope."
canonical_problem_id: "phys-diffuse-interstellar-bands"
problem_answer_id: "answer-phys-diffuse-interstellar-bands"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Specific astrochemical identification problem is outside current scope.

Rationale: Specific astrochemical identification problem is outside current scope.
...
- Reviewed in the outside-current-books double-check; Specific astrochemical identification problem outside current Corpus.
...
- Final empty-map scope classification: Declared out of scope — Specific astrochemical identification problem is outside current scope.
