---
layout: "program-doc"
title: "Granular convection - Problem Answer"
permalink: "/results/problem-ledger-answers/physics/granular-convection/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Specific granular-material dynamics problem is outside current scope."
canonical_problem_id: "phys-granular-convection"
problem_answer_id: "answer-phys-granular-convection"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Specific granular-material dynamics problem is outside current scope.

Rationale: Specific granular-material dynamics problem is outside current scope.
...
- Reviewed in the outside-current-books double-check; Specific granular-material dynamics outside current Corpus.
...
- Final empty-map scope classification: Declared out of scope — Specific granular-material dynamics problem is outside current scope.
