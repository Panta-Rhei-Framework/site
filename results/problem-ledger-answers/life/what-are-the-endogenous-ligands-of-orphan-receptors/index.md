---
layout: "program-doc"
title: "What are the endogenous ligands of orphan receptors? - Problem Answer"
permalink: "/results/problem-ledger-answers/life/what-are-the-endogenous-ligands-of-orphan-receptors/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Molecular pharmacology data gap is outside current Corpus scope."
canonical_problem_id: "life-biology-what-are-the-endogenous-ligands-of-orphan-receptors"
problem_answer_id: "answer-life-biology-what-are-the-endogenous-ligands-of-orphan-receptors"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Molecular pharmacology data gap is outside current Corpus scope.

Rationale: Molecular pharmacology data gap is outside current Corpus scope.
...
- Reviewed in the outside-current-books double-check; Molecular pharmacology data gap outside current Corpus.
...
- Final empty-map scope classification: Declared out of scope — Molecular pharmacology data gap is outside current Corpus scope.
