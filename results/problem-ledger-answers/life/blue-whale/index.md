---
layout: "program-doc"
title: "Blue whale - Problem Answer"
permalink: "/results/problem-ledger-answers/life/blue-whale/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Species-specific reproductive/sexuality data is too downstream for the current framework scope."
canonical_problem_id: "life-biology-blue-whale"
problem_answer_id: "answer-life-biology-blue-whale"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Species-specific reproductive/sexuality data is too downstream for the current framework scope.

Rationale: Species-specific reproductive/sexuality data is too downstream for the current framework scope.
...
- Reviewed in the outside-current-books double-check; Species-specific sexuality data is outside the current seven-book construction except as a distant ethology example.
...
- Final empty-map scope classification: Declared out of scope — Species-specific reproductive/sexuality data is too downstream for the current framework scope.
