---
layout: "program-doc"
title: "Butterfly migration - Problem Answer"
permalink: "/results/problem-ledger-answers/life/butterfly-migration/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained as a relevant future problem; no current answer is claimed: Migration/navigation should be addressable from agency, temporal rhythm, and environmental-orientation machinery, but needs an explicit future account."
canonical_problem_id: "life-biology-butterfly-migration"
problem_answer_id: "answer-life-biology-butterfly-migration"
...
**Backlog open problem**. The item is retained as a relevant future problem; no current answer is claimed: Migration/navigation should be addressable from agency, temporal rhythm, and environmental-orientation machinery, but needs an explicit future account.

Rationale: Migration/navigation should be addressable from agency, temporal rhythm, and environmental-orientation machinery, but needs an explicit future account.
...
- Reviewed in the adjacent-bucket pass; Book VI has agency, temporal rhythm, and ecological movement structures, but no direct butterfly-migration/navigation account is registered.
...
- Final empty-map scope classification: Open backlog problem — Migration/navigation should be addressable from agency, temporal rhythm, and environmental-orientation machinery, but needs an explicit future account.
