---
layout: "program-doc"
title: "Mechanism of action of drugs - Problem Answer"
permalink: "/results/problem-ledger-answers/life/mechanism-of-action-of-drugs/"
lane: "results"
v2_lane: "results"
type: "Problem Answer"
status: "Canonical"
summary_short: "The item is retained for source accountability, but the current Corpus declares it out of scope: Drug-specific pharmacological mechanism gaps are outside current Corpus scope."
canonical_problem_id: "life-biology-mechanism-of-action-of-drugs"
problem_answer_id: "answer-life-biology-mechanism-of-action-of-drugs"
...
**Declared out of scope**. The item is retained for source accountability, but the current Corpus declares it out of scope: Drug-specific pharmacological mechanism gaps are outside current Corpus scope.

Rationale: Drug-specific pharmacological mechanism gaps are outside current Corpus scope.
...
- Reviewed in the outside-current-books double-check; Drug-specific mechanism gaps are outside current Corpus scope.
...
- Final empty-map scope classification: Declared out of scope — Drug-specific pharmacological mechanism gaps are outside current Corpus scope.
