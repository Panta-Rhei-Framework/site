---
layout: program-doc
title: "Metaphysics / Philosophy: Ethics, Aesthetics, Language & Mind"
...
{% include claim-card.html title="Free Will and Moral Responsibility" url="/results/problem/free-will-and-moral-responsibility/" status="R" summary="The free-will-and-moral-responsibility problem is internally addressed by distinguishing scales: the agent's branching at E₃ grounds moral responsibility, while neural-scale determinism at E₂ does not undercut it. Compatibilism is dissolved as a scale confusion." %}
...
{% include claim-card.html title="Reference Problem" url="/results/problem/reference-problem/" status="R" summary="How words refer to things — the core problem of philosophy of language since Frege — is internally addressed through the framework's boundary-character correspondence: reference is not a mental pointing but a structural alignment between linguistic and worldly τ-objects." %}
