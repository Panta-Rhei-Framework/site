...
{% include claim-card.html title="No Majorana Neutrinos" url="/results/problem/0-majorana-neutrinos/" status="R" summary="Neutrinos are predicted to be Dirac, not Majorana. 0νββ decay should not be observed — a sharp falsifiable prediction." %}
