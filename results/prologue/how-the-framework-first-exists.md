...
Second, it gives the program a ground from which later claims can be [typed]({{ '/results/status-and-claim-typing/' | relative_url }}). Not all claims stand at the same level. Some belong to the strictly formal layer. Some are mathematical readouts. Some are bridge claims to observables. Some are consequence claims. By beginning with formal-system materialization, the program gives itself a disciplined way to separate these.
