...
summary_cards:
- title: Earnedness
  body: First earn the language, then earn the question, then earn the answer.
- title: Relationality
  body: Reality is approached through structure and relation before isolated substance
    and external coordination.
- title: Scope discipline
  body: Internal results, bridge claims, empirical mappings, and commitment-level
    implications are not collapsed into one register.
right_rail:
  related:
...
This principle is essential to the integrity of the whole project. Without it, the program would collapse into either inflation or defensiveness. The [scope, status, and scrutiny]({{ '/program/about/scope-status-and-scrutiny/' | relative_url }}) page articulates how these distinctions are maintained in practice.
