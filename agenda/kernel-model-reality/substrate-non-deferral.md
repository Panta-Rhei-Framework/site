...
status: "Canonical"
summary_short: "The program does not accept runtime from nowhere: substrate dependence must be treated as part of the burden, not hidden behind computation or information."
summary_cards:
  - title: "Not anti-computation"
    body: "The principle does not reject computation, information, mathematics, or simulation as powerful ideas."
  - title: "Anti-deferral"
    body: "It rejects treating execution, support, and semantics as free background once they become decisive."
  - title: "Explicit status"
    body: "Substrate dependence must be internalized, derived, typed, factored out, bridged, or left visibly unresolved."
hero_ctas:
