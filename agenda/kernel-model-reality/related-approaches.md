...
summary_cards:
  ...
  - title: "Comparative"
    body: "Each comparison asks what the approach removes, what Panta Rhei shares, what remains external, and how the burden differs."
  - title: "Disciplined"
    body: "The purpose is positioning, not declaring replacement or superiority."
hero_ctas:
...
For the longer expert-facing matrix and expanded discussion, see [Related Approaches: Deep Comparison]({{ '/agenda/kernel-model-reality/related-approaches/deep-comparison/' | relative_url }}).
