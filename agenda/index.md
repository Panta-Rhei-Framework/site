...
The first three surfaces state the burden. The [Construction Roadmap]({{ '/agenda/construction-roadmap/' | relative_url }}) states the logical build-order required by that burden.
...
<div class="v2-system-strip" aria-label="Research agenda burden of proof flow">
  ...
  <span>-></span>
  <a href="{{ '/agenda/kernel-model-reality/' | relative_url }}">Ontic burden</a>
  <span>-></span>
  <a href="{{ '/agenda/construction-roadmap/' | relative_url }}">Build order</a>
  <span>-></span>
