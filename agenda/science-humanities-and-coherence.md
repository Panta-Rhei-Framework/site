...
summary_cards:
- title: Not collapse
  body: The program does not collapse all registers into one. It distinguishes them
    sharply.
- title: Not ceasefire
  body: But it also refuses to treat fragmentation between scientific and existential
...
Whether Panta Rhei succeeds in that remains [open to scrutiny]({{ '/program/about/scope-status-and-scrutiny/' | relative_url }}).

But the refusal to accept fragmentation as a final virtue is one of the deepest reasons [the program exists]({{ '/program/about/why-this-program-exists/' | relative_url }}).
