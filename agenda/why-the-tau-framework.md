...
Tau is not presented as "one more formal language" among many. It is the current candidate foundation through which the program tests whether its strongest [desiderata]({{ '/agenda/research-aim-and-desiderata/' | relative_url }}) can be realized at all.
