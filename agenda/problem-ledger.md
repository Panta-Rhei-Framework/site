...
hero_ctas:
  ...
  - label: "Browse Domain Ledgers"
    url: /agenda/problem-ledger/#domain-ledgers
...
<div class="v2-grid">
  ...
  <a class="v2-tile" href="{{ '/agenda/problem-ledger/mathematics/' | relative_url }}">
    <strong>Mathematics Problem Ledger</strong>
    <span>Clay 7 + Langlands as selected foundational stress tests.</span>
  </a>
  <a class="v2-tile" href="{{ '/agenda/problem-ledger/physics/' | relative_url }}">
