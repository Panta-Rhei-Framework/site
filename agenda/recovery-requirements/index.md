...
<div class="v2-grid">
  <a class="v2-tile" href="{{ '/agenda/recovery-requirements/mathematics/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/agenda/recovery-requirements/physics/' | relative_url }}">
  ...
  <a class="v2-tile" href="{{ '/agenda/recovery-requirements/life/' | relative_url }}">
    <strong>Life</strong>
  ...
  <a class="v2-tile" href="{{ '/agenda/recovery-requirements/metaphysics/' | relative_url }}">
