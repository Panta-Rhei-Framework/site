...
right_rail:
  related:
    ...
    - title: "Mathematical Refusals"
      url: /agenda/recovery-requirements/mathematics/refusals/
...
These recovery targets must be read together with the [Mathematical Refusals]({{ '/agenda/recovery-requirements/mathematics/refusals/' | relative_url }}). The tau-kernel does not recover mathematics by silently importing unrestricted classical background assumptions.
