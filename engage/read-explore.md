...
status: "Canonical"
permalink: /engage/read-explore/
summary_short: "Reading pathways for visitors who want to understand the program before inspecting or challenging it."
summary_cards:
...
<div class="v2-grid">
  ...
  <a class="v2-tile" href="{{ '/results/world-readout/' | relative_url }}">
    ...
    <p>Read the domain mirrors across mathematics, physics, life, and metaphysics.</p>
  </a>
