...
title: "Media & Contact"
lane: engage
permalink: /engage/media-and-contact/
summary_short: "Typed contact routes for media, technical inquiry, institutions, and general correspondence."
summary_cards:
  - title: "Typed routing"
    body: "Please indicate your inquiry type so we can route your message to the right person."
  - title: "Response time"
    body: "We aim to respond within one week. Complex technical inquiries may take longer."
right_rail:
  related:
...
**What we can provide**: Technical clarification, registry references, TauLib module pointers, guided tour recommendations, scope status for specific claims.
