...
lane: discover
v2_lane: discover
permalink: /discover/big-questions/
...
<div class="v2-grid v2-grid-2">
  ...
  <a class="v2-tile" href="{{ '/program/' | relative_url }}">
    <h3>Coherence</h3>
    <p>Can scientific and existential registers be held inside one disciplined formal picture?</p>
  </a>
  <a class="v2-tile" href="{{ '/verify/' | relative_url }}">
    <h3>Scrutiny</h3>
    <p>What would it take for this program to fail, and where can it be checked?</p>
  </a>
</div>
